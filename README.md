...
The original `anthro.mat` file contains both anthropometric measurements and subject information. In hrtfpykit these are handled as separate dataset resource concepts. `AnthropometrySpec` represents numeric body and ear measurements. `MetadataSpec` represents subject information such as sex, age, weight, and recording dates. Either resource can be requested as part of a dataset sample depending on the experiment, including analysis workflows or deep learning models that use subject data.
